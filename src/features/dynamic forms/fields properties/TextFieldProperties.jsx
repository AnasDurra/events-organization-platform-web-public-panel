...
export default function TextFieldProperties({ field, onNameChange, onLabelChange, onIsRequiredChange }) {
    ...
    >
        ...
        <Space
            ...
            className='w-full px-4 my-2'
        >
            <Title level={5} htmlFor='isRequired' style={{margin:0}}> Is Required</Title> 
            <Checkbox
