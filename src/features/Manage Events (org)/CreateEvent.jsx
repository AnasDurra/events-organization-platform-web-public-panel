          ...
          if (key === "tags") {
            ...
            dataToSend.days?.forEach((day, dayIndex) => {
              ...
              slots.forEach((slot, slotIndex) => {
                ...
                formData.append(
                  `days[${dayIndex}][slots][${slotIndex}][start_time]`,
                  start_time
                );
                formData.append(
                  `days[${dayIndex}][slots][${slotIndex}][end_time]`,
                  end_time
                );
                formData.append(
                  `days[${dayIndex}][slots][${slotIndex}][label]`,
                  label
                );
              });
            });
            ...
            <Meta
              ...
              avatar={
                <Avatar
                  ...
                  icon={<UserOutlined />}
                  src={
                    "https://weevent-api-7uxa.onrender.com/api/organization/mainPicture/images8fb03f6c-6c84-4e1a-b0a5-927551254774.png"
                  }
                  style={{
                    textAlign: "center",
