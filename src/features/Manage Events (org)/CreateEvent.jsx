    ...
    const onFormsFinish = async () => {
        try {
            ...
            for (let key in eventMediaFormValues?.photos?.fileList) {
                eventMediaFormValues.photos.fileList[key] = eventMediaFormValues.photos?.fileList[key]?.originFileObj;
            }
            for (let key in eventMediaFormValues?.attachments?.fileList) {
                eventMediaFormValues.attachments.fileList[key] =
                    eventMediaFormValues.attachments?.fileList[key]?.originFileObj;
            }
                                                ...
                                                <Col span={10}>
                                                    ...
                                                    >
                                                        <DatePicker
                                                            ...
                                                            value={
                                                                days[dayIndex].value
                                                                    ? dayjs(days[dayIndex].value, 'DD-MM-YYYY')
                                                                    : null
                                                            }
                                                    ...
                                                    {days[dayIndex]?.slots?.map((slot, slotIndex) => (
                                                        <div key={slotIndex}>
                                                            <Tooltip
                                                                ...
                                                                placement='leftTop'
                                                                defaultOpen={days[dayIndex]?.value}
                                                            >
                                                                <Form.Item
