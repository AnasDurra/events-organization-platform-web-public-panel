...
const EventCover = ({ data, setIsUpdateModalOpen }) => {
  const [
    checkIsEventReportedReported,
    { isFetching: isIsEventReportedFetching },
  ] = useLazyIsEventReportedQuery();
        ...
        <Space size={10} direction="vertical">
          ...
          <Space style={{ display: "flex", justifyContent: "space-between" }}>
            <Space direction="vertical">
              ...
              <Popover
                content={
                  <OrgPopoverContent organization={data?.organization} />
                }
                title="Organization Info"
              >
                <Link
                  to={`/org/${data?.organization?.id}`}
                    ...
                    <Space.Compact>
                      ...
                      <Tooltip title="Show Attendees">
                        <Button
                          ...
                          onClick={() =>
                            navigate(`/event/show/${data?.event_id}/attendees`)
                          }
                        />
                      </Tooltip>
        ...
        <Card.Meta
          ...
          avatar={
            <Image
              ...
              width={50}
              height={50}
              src={`${URL}/organization/mainPicture/${organization?.main_picture
                ?.split("/")
                .pop()}`}
