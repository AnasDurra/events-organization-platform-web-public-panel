import { Button, Col, Divider, Image, List, Row, Skeleton, Space, Tabs, Typography, message } from 'antd';
...
const contactOrder = ['Phone Number', 'Email', 'Facebook', 'WhatsApp', 'LinkedIn'];
