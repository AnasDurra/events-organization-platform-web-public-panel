...
export default function OrganizerLayout({ roles }) {
    ...
    >
      ...
      >
        <span style={{ display: "flex", alignItems: "center" }}>
          <UserOutlined style={{ marginRight: "8px", fontSize: "18px" }} /> My
          Profile
        </span>
      </Menu.Item>
      ...
      >
        <span style={{ display: "flex", alignItems: "center" }}>
          <LogoutOutlined style={{ marginRight: "8px", fontSize: "18px" }} />{" "}
          Logout
        </span>
      </Menu.Item>
    </Menu>
  ...
  const notifications = [
    ...
    {
      id: 2,
      message: "Event reminder: Tomorrow at 10 AM",
      timestamp: "2 hrs ago",
    },
    {
      id: 3,
      message: "You have 5 pending invitations",
      timestamp: "3 hrs ago",
    },
  ];
        ...
        <Menu.Item key={notification.id} style={{ padding: "8px 16px" }}>
          ...
          >
            <div>
              ...
              <Typography.Text style={{ paddingRight: "13px" }}>
              ...
              >
                ...
                >
                  <a onClick={(e) => e.preventDefault()}>
                    <img
                      src="https://weevent-api-7uxa.onrender.com/api/organization/mainPicture/images8fb03f6c-6c84-4e1a-b0a5-927551254774.png"
                      alt="Profile"
                      style={{
                        width: "3em",
                        aspectRatio: "1",
